...
if("TRUE" STREQUAL "TRUE")
  set(console_SOURCE_PREFIX /home/ssj/ros_ws/src/console)
  set(console_DEVEL_PREFIX /home/ssj/ros_ws/devel)
  set(console_INSTALL_PREFIX "")
  set(console_PREFIX ${console_DEVEL_PREFIX})
else()
  set(console_SOURCE_PREFIX "")
  set(console_DEVEL_PREFIX "")
  set(console_INSTALL_PREFIX /home/ssj/ros_ws/install)
...
if(NOT "/home/ssj/ros_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'console' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ssj/ros_ws/src/console/${idir}'.  Ask the maintainer 'dji <todo@dji.com>' to fix it.")
    endif()
...
set(console_EXPORTED_TARGETS "console_generate_messages_cpp;console_generate_messages_lisp;console_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${console_dep}_FOUND)
      find_package(${console_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${console_dep} REQUIRED ${depend_list})
  endif()
