...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BehaviourEvent-request>)))
  ...
  (cl:format cl:nil "~%~%~%~%string                                  name~%pal_behaviour_msgs/BehaviourArgument[]  arguments~%~%================================================================================~%MSG: pal_behaviour_msgs/BehaviourArgument~%## SMC event~%~%#Header header~%~%string           key~%string           value~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BehaviourEvent-request)))
  "Returns full string definition for message of type 'BehaviourEvent-request"
  (cl:format cl:nil "~%~%~%~%string                                  name~%pal_behaviour_msgs/BehaviourArgument[]  arguments~%~%================================================================================~%MSG: pal_behaviour_msgs/BehaviourArgument~%## SMC event~%~%#Header header~%~%string           key~%string           value~%~%~%~%"))
