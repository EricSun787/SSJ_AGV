...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SafetyZone-request>)))
  ...
  (cl:format cl:nil "~%byte NO_SENSORS = 0~%byte ALL_SENSORS = 127~%~%byte FRONT_SONARS = 1~%byte LEFT_SONARS = 2~%byte RIGHT_SONARS = 4~%byte BACK_SONARS = 8~%byte TORSO_SONARS = 16~%byte ONLY_SONARS = 31~%~%byte BASE_LASER = 32~%byte TORSO_LASER = 64~%byte ONLY_LASERS = 96~%~%~%~%~%float64 distance~%~%~%float64 leftAngleRad~%float64 rightAngleRad~%~%uint32 sensorMask~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SafetyZone-request)))
  "Returns full string definition for message of type 'SafetyZone-request"
  (cl:format cl:nil "~%byte NO_SENSORS = 0~%byte ALL_SENSORS = 127~%~%byte FRONT_SONARS = 1~%byte LEFT_SONARS = 2~%byte RIGHT_SONARS = 4~%byte BACK_SONARS = 8~%byte TORSO_SONARS = 16~%byte ONLY_SONARS = 31~%~%byte BASE_LASER = 32~%byte TORSO_LASER = 64~%byte ONLY_LASERS = 96~%~%~%~%~%float64 distance~%~%~%float64 leftAngleRad~%float64 rightAngleRad~%~%uint32 sensorMask~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SafetyZone-response>)))
  ...
  (cl:format cl:nil "~%~%~%~%bool leftSafe~%float64 leftMinDist~%float64 leftMinDistAngleRad~%~%bool rightSafe~%float64 rightMinDist~%float64 rightMinDistAngleRad~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SafetyZone-response)))
  "Returns full string definition for message of type 'SafetyZone-response"
  (cl:format cl:nil "~%~%~%~%bool leftSafe~%float64 leftMinDist~%float64 leftMinDistAngleRad~%~%bool rightSafe~%float64 rightMinDist~%float64 rightMinDistAngleRad~%~%~%~%"))
