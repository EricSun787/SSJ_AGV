...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimedBlinkEffect-request>)))
  ...
  (cl:format cl:nil "~%~%LedGroup leds~%~%~%std_msgs/ColorRGBA firstColor~%std_msgs/ColorRGBA secondColor~%~%duration firstColorDuration~%duration secondColorDuration~%~%~%~%duration effectDuration~%~%~%uint8 priority~%~%~%================================================================================~%MSG: pal_device_msgs/LedGroup~%byte LEFT_EAR = 1~%byte RIGHT_EAR = 2~%~%#OR-mask of the selected leds~%uint32 ledMask~%~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimedBlinkEffect-request)))
  "Returns full string definition for message of type 'TimedBlinkEffect-request"
  (cl:format cl:nil "~%~%LedGroup leds~%~%~%std_msgs/ColorRGBA firstColor~%std_msgs/ColorRGBA secondColor~%~%duration firstColorDuration~%duration secondColorDuration~%~%~%~%duration effectDuration~%~%~%uint8 priority~%~%~%================================================================================~%MSG: pal_device_msgs/LedGroup~%byte LEFT_EAR = 1~%byte RIGHT_EAR = 2~%~%#OR-mask of the selected leds~%uint32 ledMask~%~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimedBlinkEffect-response>)))
  ...
  (cl:format cl:nil "~%uint32 effectId~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimedBlinkEffect-response)))
  "Returns full string definition for message of type 'TimedBlinkEffect-response"
  (cl:format cl:nil "~%uint32 effectId~%~%~%~%~%"))
