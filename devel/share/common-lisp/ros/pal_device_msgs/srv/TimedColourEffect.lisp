...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimedColourEffect-request>)))
  ...
  (cl:format cl:nil "~%~%LedGroup leds~%~%~%std_msgs/ColorRGBA color~%~%~%duration effectDuration~%~%~%uint8 priority~%~%~%================================================================================~%MSG: pal_device_msgs/LedGroup~%byte LEFT_EAR = 1~%byte RIGHT_EAR = 2~%~%#OR-mask of the selected leds~%uint32 ledMask~%~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimedColourEffect-request)))
  "Returns full string definition for message of type 'TimedColourEffect-request"
  (cl:format cl:nil "~%~%LedGroup leds~%~%~%std_msgs/ColorRGBA color~%~%~%duration effectDuration~%~%~%uint8 priority~%~%~%================================================================================~%MSG: pal_device_msgs/LedGroup~%byte LEFT_EAR = 1~%byte RIGHT_EAR = 2~%~%#OR-mask of the selected leds~%uint32 ledMask~%~%================================================================================~%MSG: std_msgs/ColorRGBA~%float32 r~%float32 g~%float32 b~%float32 a~%~%~%"))
