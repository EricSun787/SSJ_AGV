...
(cl:defmethod cl:initialize-instance :after ((m <serial_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'serial_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name console-msg:<serial_data> is deprecated: use console-msg:serial_data instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <serial_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader console-msg:data-val is deprecated.  Use console-msg:data instead.")
  (data m))
