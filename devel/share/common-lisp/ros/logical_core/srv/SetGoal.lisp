...
(cl:in-package logical_core-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetGoal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGoal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name logical_core-srv:<SetGoal-request> is deprecated: use logical_core-srv:SetGoal-request instead.")))

(cl:ensure-generic-function 'target_pose-val :lambda-list '(m))
(cl:defmethod target_pose-val ((m <SetGoal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader logical_core-srv:target_pose-val is deprecated.  Use logical_core-srv:target_pose instead.")
  (target_pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetGoal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGoal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name logical_core-srv:<SetGoal-response> is deprecated: use logical_core-srv:SetGoal-response instead.")))

(cl:ensure-generic-function 'current_pose-val :lambda-list '(m))
(cl:defmethod current_pose-val ((m <SetGoal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader logical_core-srv:current_pose-val is deprecated.  Use logical_core-srv:current_pose instead.")
  (current_pose m))
