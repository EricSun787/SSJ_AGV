...
if("TRUE" STREQUAL "TRUE")
  set(naoqi_sensors_py_SOURCE_PREFIX /home/ssj/ros_ws/src/naoqi_bridge/naoqi_sensors_py)
  set(naoqi_sensors_py_DEVEL_PREFIX /home/ssj/ros_ws/devel)
  ...
  set(naoqi_sensors_py_INSTALL_PREFIX /home/ssj/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'naoqi_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Séverin Lemaignan <severin.lemaignan@epfl.ch>, Surya Ambrose <surya.ambrose@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'naoqi_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ssj/ros_ws/src/naoqi_bridge/naoqi_sensors_py/${idir}'.  Ask the maintainer 'Séverin Lemaignan <severin.lemaignan@epfl.ch>, Surya Ambrose <surya.ambrose@gmail.com>' to fix it.")
    endif()
