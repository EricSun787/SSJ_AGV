...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/ssj/ros_ws/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/ssj/ros_ws/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/ssj/ros_ws/install)
...
if(NOT "/home/ssj/ros_ws/src/vision_opencv/image_geometry/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/ssj/ros_ws/src/vision_opencv/image_geometry/include;/usr/local/include;/usr/local/include/opencv")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ssj/ros_ws/src/vision_opencv/image_geometry/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
    _list_append_unique(image_geometry_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_geometry;/usr/local/lib/libopencv_calib3d.so.3.3.0;/usr/local/lib/libopencv_core.so.3.3.0;/usr/local/lib/libopencv_dnn.so.3.3.0;/usr/local/lib/libopencv_features2d.so.3.3.0;/usr/local/lib/libopencv_flann.so.3.3.0;/usr/local/lib/libopencv_highgui.so.3.3.0;/usr/local/lib/libopencv_imgcodecs.so.3.3.0;/usr/local/lib/libopencv_imgproc.so.3.3.0;/usr/local/lib/libopencv_ml.so.3.3.0;/usr/local/lib/libopencv_objdetect.so.3.3.0;/usr/local/lib/libopencv_photo.so.3.3.0;/usr/local/lib/libopencv_shape.so.3.3.0;/usr/local/lib/libopencv_stitching.so.3.3.0;/usr/local/lib/libopencv_superres.so.3.3.0;/usr/local/lib/libopencv_video.so.3.3.0;/usr/local/lib/libopencv_videoio.so.3.3.0;/usr/local/lib/libopencv_videostab.so.3.3.0;/usr/local/lib/libopencv_viz.so.3.3.0;/usr/local/lib/libopencv_aruco.so.3.3.0;/usr/local/lib/libopencv_bgsegm.so.3.3.0;/usr/local/lib/libopencv_bioinspired.so.3.3.0;/usr/local/lib/libopencv_ccalib.so.3.3.0;/usr/local/lib/libopencv_datasets.so.3.3.0;/usr/local/lib/libopencv_dpm.so.3.3.0;/usr/local/lib/libopencv_face.so.3.3.0;/usr/local/lib/libopencv_freetype.so.3.3.0;/usr/local/lib/libopencv_fuzzy.so.3.3.0;/usr/local/lib/libopencv_img_hash.so.3.3.0;/usr/local/lib/libopencv_line_descriptor.so.3.3.0;/usr/local/lib/libopencv_optflow.so.3.3.0;/usr/local/lib/libopencv_phase_unwrapping.so.3.3.0;/usr/local/lib/libopencv_plot.so.3.3.0;/usr/local/lib/libopencv_reg.so.3.3.0;/usr/local/lib/libopencv_rgbd.so.3.3.0;/usr/local/lib/libopencv_saliency.so.3.3.0;/usr/local/lib/libopencv_stereo.so.3.3.0;/usr/local/lib/libopencv_structured_light.so.3.3.0;/usr/local/lib/libopencv_surface_matching.so.3.3.0;/usr/local/lib/libopencv_text.so.3.3.0;/usr/local/lib/libopencv_tracking.so.3.3.0;/usr/local/lib/libopencv_xfeatures2d.so.3.3.0;/usr/local/lib/libopencv_ximgproc.so.3.3.0;/usr/local/lib/libopencv_xobjdetect.so.3.3.0;/usr/local/lib/libopencv_xphoto.so.3.3.0")
