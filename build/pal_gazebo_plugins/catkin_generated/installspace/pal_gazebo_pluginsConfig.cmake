...
if(NOT "include;/usr/include;/usr/include/gazebo-2.2;/usr/include/sdformat-1.4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pal_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ssj/ros_ws/install/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Luca Marchionni <luca.marchionni@pal-robotics.com>' to fix it.")
    endif()
