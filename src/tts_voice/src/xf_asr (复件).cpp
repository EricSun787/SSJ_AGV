...
const char * ASR_RES_PATH        = "fo|/home/ssj/Robot/voice/bin/msc/res/asr/common.jet"; //离线语法识别资源路径
const char * GRM_BUILD_PATH      = "/home/ssj/Robot/voice/bin/msc/res/asr/GrmBuilld"; //构建离线语法识别网络生成数据保存路径
const char * GRM_FILE            = "/home/ssj/Robot/voice/bin/call.bnf"; //构建离线识别语法网络所用的语法文件
//const char * GRM_FILE            = "/home/ssj/xunfei/bin/gm_continuous_digit.abnf"; //构建离线识别语法网络所用的语法文件abnf
//const char * listened_file            ="/home/ssj/Robot/voice/bin/wav/ddhgdw.pcm";
const char * listened_file            ="/home/ssj/Robot/voice/wav/listened.wav";
...
int build_grammar(UserData *udata)
{
    ...
    //ret = QISRBuildGrammar("abnf", grm_content, grm_cnt_len, grm_build_params, build_grm_cb, udata);
...
{
    const char *login_config    = "appid = 59afe284"; //登录参数
    int ret                     = 0 ;
