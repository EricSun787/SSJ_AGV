...
const char* FileName = "/home/ssj/Music/cam/Music/voice.wav";
const char* PlayPath = "play /home/ssj/Music/cam/Music/voice.wav";
...
{
	int         ret                  = MSP_SUCCESS;
	const char* login_params         = "appid = 59afe284, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
	/*
	* rdn:           合成音频数字发音方式
	* volume:        合成音频的音量
	* pitch:         合成音频的音调
